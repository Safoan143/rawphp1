                ...
                <div class="row">
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form action="../control/store.php" method="POST" class="user">
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input name="fname" type="text" class="form-control form-control-user" id="exampleFirstName"
                                            placeholder="First Name">
                                            <span class="text-danger"><?= isset($_SESSION['register_error']['fname_error']) ? $_SESSION['register_error']['fname_error'] : '' ?></span>
                                    </div>
                                    <div class="col-sm-6">
                                        <input name="lname" type="text" class="form-control form-control-user" id="exampleLastName"
                                            placeholder="Last Name">
                                            <span class="text-danger"><?= isset($_SESSION['register_error']['lname_error']) ? $_SESSION['register_error']['lname_error'] : '' ?></span>
                                    </div>
                                </div>
